...
if ($receipt_id <= 0) {
    ...
    $check_sql = "SELECT * FROM hba1c WHERE receipt_id = $receipt_id";
    ...
    if (mysqli_num_rows($check_result) > 0) {
        ...
        $existing_data = ['hba1c' => '', 'reporting_datetime' => ''];
    }
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($edit_mode) {
        $update_sql = "UPDATE hba1c SET hba1c = '$hba1c', reporting_datetime = NOW() WHERE receipt_id = $receipt_id";
        ...
        $insert_sql = "INSERT INTO hba1c (receipt_id, hba1c, reporting_datetime) VALUES ($receipt_id, '$hba1c', NOW())";
...
<div class="container" style="margin-bottom: 100px;">
    <h2><?= $edit_mode ? "Edit HbA1c Test Result" : "Enter HbA1c Test Result" ?></h2>
    ...
    <form method="post" action="">
        <label for="hba1c">HbA1c Result:</label>
        <input type="text" name="hba1c" id="hba1c" required value="<?= htmlspecialchars($existing_data['hba1c']) ?>" />
