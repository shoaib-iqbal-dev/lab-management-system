...
if ($receipt_id <= 0) {
    ...
    $check_sql = "SELECT * FROM urea WHERE receipt_id = $receipt_id";
    ...
    if (mysqli_num_rows($check_result) > 0) {
        ...
        $existing_data = ['serum_urea' => '', 'reporting_datetime' => ''];
    }
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($edit_mode) {
        $update_sql = "UPDATE urea SET serum_urea = '$serum_urea', reporting_datetime = NOW() WHERE receipt_id = $receipt_id";
        ...
        $insert_sql = "INSERT INTO urea (receipt_id, serum_urea, reporting_datetime) VALUES ($receipt_id, '$serum_urea', NOW())";
