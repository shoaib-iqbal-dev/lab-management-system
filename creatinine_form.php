...
if ($receipt_id <= 0) {
    ...
    $check_sql = "SELECT * FROM creatinine WHERE receipt_id = $receipt_id";
    ...
    if (mysqli_num_rows($check_result) > 0) {
        ...
        $existing_data = ['serum_creatinine' => '', 'reporting_datetime' => ''];
    }
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($edit_mode) {
        $update_sql = "UPDATE creatinine SET serum_creatinine = '$serum_creatinine', reporting_datetime = NOW() WHERE receipt_id = $receipt_id";
        ...
        $insert_sql = "INSERT INTO creatinine (receipt_id, serum_creatinine, reporting_datetime) VALUES ($receipt_id, '$serum_creatinine', NOW())";
...
<title>Serum Creatinine Test Form</title>
<style>
        body {
