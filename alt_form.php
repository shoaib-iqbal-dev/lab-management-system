...
if ($receipt_id <= 0) {
    ...
    $check_receipt_sql = "SELECT * FROM alt WHERE receipt_id = '$receipt_id'";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($edit_mode) {
        ...
        // Insert new record
        $insert_sql = "INSERT INTO alt (
                        receipt_id, serum_alt, reporting_datetime
                    ) VALUES (
                        '$receipt_id', '$serum_alt', NOW()
                    )";
