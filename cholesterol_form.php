...
if ($receipt_id <= 0) {
    ...
    $check_sql = "SELECT * FROM cholesterol WHERE receipt_id = $receipt_id";
    ...
    if (mysqli_num_rows($check_result) > 0) {
        ...
        $existing_data = ['serum_total_cholesterol' => '', 'reporting_datetime' => ''];
    }
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($edit_mode) {
        $update_sql = "UPDATE cholesterol SET serum_total_cholesterol = '$serum_total_cholesterol', reporting_datetime = NOW() WHERE receipt_id = $receipt_id";
        ...
        $insert_sql = "INSERT INTO cholesterol (receipt_id, serum_total_cholesterol, reporting_datetime) VALUES ($receipt_id, '$serum_total_cholesterol', NOW())";
...
<title>CHOLESTEROL Test Form</title>
<style>
        body {
