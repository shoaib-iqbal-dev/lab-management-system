...
if ($receipt_id <= 0) {
    ...
    $check_sql = "SELECT * FROM hiv WHERE receipt_id = $receipt_id";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($edit_mode) {
        $update_sql = "UPDATE hiv SET hep_b = '$hep_b', hep_c = '$hep_c', hiv = '$hiv', reporting_datetime = NOW() WHERE receipt_id = $receipt_id";
        ...
        $insert_sql = "INSERT INTO hiv (receipt_id, hep_b, hep_c, hiv, reporting_datetime) VALUES ($receipt_id, '$hep_b', '$hep_c', '$hiv', NOW())";
