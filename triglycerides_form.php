...
if ($receipt_id <= 0) {
    ...
    $check_sql = "SELECT * FROM triglycerides WHERE receipt_id = $receipt_id";
    ...
    if (mysqli_num_rows($check_result) > 0) {
        ...
        $existing_data = ['serum_triglycerides' => '', 'reporting_datetime' => ''];
    }
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($edit_mode) {
        $update_sql = "UPDATE triglycerides SET serum_triglycerides = '$serum_triglycerides', reporting_datetime = NOW() WHERE receipt_id = $receipt_id";
        ...
        $insert_sql = "INSERT INTO triglycerides (receipt_id, serum_triglycerides, reporting_datetime) VALUES ($receipt_id, '$serum_triglycerides', NOW())";
...
<title>TRIGLYCERIDES Test Form</title>
<style>
        body {
