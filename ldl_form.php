...
if ($receipt_id <= 0) {
    ...
    $check_sql = "SELECT * FROM ldl WHERE receipt_id = $receipt_id";
    ...
    if (mysqli_num_rows($check_result) > 0) {
        ...
        $existing_data = ['serum_ldl_cholesterol' => '', 'reporting_datetime' => ''];
    }
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($edit_mode) {
        $update_sql = "UPDATE ldl SET serum_ldl_cholesterol = '$serum_ldl_cholesterol', reporting_datetime = NOW() WHERE receipt_id = $receipt_id";
        ...
        $insert_sql = "INSERT INTO ldl (receipt_id, serum_ldl_cholesterol, reporting_datetime) VALUES ($receipt_id, '$serum_ldl_cholesterol', NOW())";
