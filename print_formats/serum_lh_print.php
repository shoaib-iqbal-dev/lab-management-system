...
// Validate input
if (empty($receipt_id) || empty($mr_no) || strtolower($test_name) !== 'serum lh') {
...
$testQuery = "SELECT serum_lh.*, receipts.receipt_no, receipts.actual_fee, receipts.discount, receipts.total_fee, receipts.payment_date
              FROM serum_lh
              LEFT JOIN receipts ON serum_lh.receipt_id = receipts.receipt_id
              WHERE serum_lh.receipt_id = ?";
$testStmt = $conn->prepare($testQuery);
$testStmt->bind_param("i", $receipt_id);
$testStmt->execute();
$testResult = $testStmt->get_result();
if ($testResult->num_rows === 0) {
    echo "<h3>No Serum Lh result found for this receipt.</h3>";
    exit;
}
...
<tr>
<td>Follicular Phase: 2.4-12.6 IU/L
</td>
</tr>
<tr>
<td>Ovulation Phase: 14.0-95.6 IU/L
</td>
</tr>
<tr>
<td>Luteal Phase: 1.0-11.4 IU/L
</td>
</tr>
<tr>
<td>Post menopause: 7.7-58.5 IU/L
</td>
</tr>
</table>
