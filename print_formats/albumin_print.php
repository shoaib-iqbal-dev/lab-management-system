...
// Validate input
if (empty($receipt_id) || empty($mr_no) || strtolower($test_name) !== 'albumin') {
...
$testQuery = "SELECT albumin.*, receipts.receipt_no, receipts.actual_fee, receipts.discount, receipts.total_fee, receipts.payment_date
              FROM albumin
              LEFT JOIN receipts ON albumin.receipt_id = receipts.receipt_id
              WHERE albumin.receipt_id = ?";
