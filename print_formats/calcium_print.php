...
// Validate input
if (empty($receipt_id) || empty($mr_no) || strtolower($test_name) !== 'calcium') {
...
$testQuery = "SELECT calcium.*, receipts.receipt_no, receipts.actual_fee, receipts.discount, receipts.total_fee, receipts.payment_date
              FROM calcium
              LEFT JOIN receipts ON calcium.receipt_id = receipts.receipt_id
              WHERE calcium.receipt_id = ?";
...
<table width="100%">
  <tr>
	...
	<h3 style="margin-bottom: 0px;">Department of Clinical Chemistry</h3>
	</td>
...
<tr>
    ...
    <tr>
	<td>Calcium</td>
	<td>1 - 14 years : 9.6 - 10.6 mg/dl<br>Adults : 8.5 - 10.5 mg/dl</td>
	<td><?= $row['calcium'] ?></td>
	<td></td>
	</tr>
