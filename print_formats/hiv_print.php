...
// Validate input
if (empty($receipt_id) || empty($mr_no) || strtolower($test_name) !== 'hiv') {
...
$testQuery = "SELECT hiv.*, receipts.receipt_no, receipts.actual_fee, receipts.discount, receipts.total_fee, receipts.payment_date
              FROM hiv
              LEFT JOIN receipts ON hiv.receipt_id = receipts.receipt_id
              WHERE hiv.receipt_id = ?";
