...
// Validate input
if (empty($receipt_id) || empty($mr_no) || strtolower($test_name) !== 'dengue serology') {
...
$testQuery = "SELECT dengue_serology.*, receipts.receipt_no, receipts.actual_fee, receipts.discount, receipts.total_fee, receipts.payment_date
              FROM dengue_serology
              LEFT JOIN receipts ON dengue_serology.receipt_id = receipts.receipt_id
              WHERE dengue_serology.receipt_id = ?";
$testStmt = $conn->prepare($testQuery);
$testStmt->bind_param("i", $receipt_id);
$testStmt->execute();
$testResult = $testStmt->get_result();
if ($testResult->num_rows === 0) {
    echo "<h3>No Dengue Serology result found for this receipt.</h3>";
    exit;
}
...
<html>
<head>
    <title>Dengue Serology Report</title>
    <style>
        body {
...
<hr style="margin-top: 0px;margin-bottom: 0px;">
<p style="margin-bottom: 0px;margin-top: 0px;"><b>Dengue IGg Antibiodies</b></p>
...
<tr>
        ...
        <th style="width: 32%; border-top: none; border-bottom: none; border-right: none;"><h1><?= $row['igg'] ?></h1></th>
    </tr>
	<tr>
...
<hr style="margin-top: 0px;margin-bottom: 0px;">
<p style="margin-bottom: 0px;margin-top: 0px;"><b>Dengue IGm Antibiodies</b></p>

<table class="result-table" style="margin-top: 0px;margin-bottom: 10px; font-size:12">
    
<tr>
        <th style="width: 40%; border-left: none; border-top: none; border-bottom: none;"></th>
        <th style="width: 32%; border-top: none; border-bottom: none; border-right: none;"><h1><?= $row['igm'] ?></h1></th>
    </tr>
	<tr>
		<td style="width: 40%; border-left: none; border-top: none;"> .</td>
		<td style="border-top: none; border-right: none;"></td>
...
<p style="font-size:12px;"><b>Method:</b> Immuno chromatographic.</p>
