...
// Validate input
if (empty($receipt_id) || empty($mr_no) || strtolower($test_name) !== 'hep c') {
...
$testQuery = "SELECT hep_c.*, receipts.receipt_no, receipts.actual_fee, receipts.discount, receipts.total_fee, receipts.payment_date
              FROM hep_c
              LEFT JOIN receipts ON hep_c.receipt_id = receipts.receipt_id
              WHERE hep_c.receipt_id = ?";
