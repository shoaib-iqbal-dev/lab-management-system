...
// Validate input
if (empty($receipt_id) || empty($mr_no) || strtolower($test_name) !== 'malaria parasite') {
...
$testQuery = "SELECT malaria_parasite.*, receipts.receipt_no, receipts.actual_fee, receipts.discount, receipts.total_fee, receipts.payment_date
              FROM malaria_parasite
              LEFT JOIN receipts ON malaria_parasite.receipt_id = receipts.receipt_id
              WHERE malaria_parasite.receipt_id = ?";
$testStmt = $conn->prepare($testQuery);
$testStmt->bind_param("i", $receipt_id);
$testStmt->execute();
$testResult = $testStmt->get_result();
if ($testResult->num_rows === 0) {
    echo "<h3>No Malaria Parasite result found for this receipt.</h3>";
    exit;
}
...
<html>
<head>
    <title>Malaria Parasite Report</title>
    <style>
        body {
...
<table width="100%">
  <tr>
	...
	<h3 style="margin-bottom: 0px;">Department of Parasitology</h3>
	</td>
...
<hr style="margin-top: 0px;margin-bottom: 0px;">
<p style="margin-bottom: 0px;margin-top: 0px;"><b>Blood Malaria Parasite (PV)</b></p>
...
<tr>
        ...
        <th style="width: 32%; border-top: none; border-bottom: none; border-right: none;"><h1><?= $row['malaria_parasite_pv'] ?></h1></th>
    </tr>
	<tr>
...
<hr style="margin-top: 0px;margin-bottom: 0px;">
<p style="margin-bottom: 0px;margin-top: 0px;"><b>Blood Malaria Parasite (Pf)</b></p>

<table class="result-table" style="margin-top: 0px;margin-bottom: 10px; font-size:12">
    
<tr>
        <th style="width: 40%; border-left: none; border-top: none; border-bottom: none;"></th>
        <th style="width: 32%; border-top: none; border-bottom: none; border-right: none;"><h1><?= $row['malaria_parasite_pf'] ?></h1></th>
    </tr>
	<tr>
		<td style="width: 40%; border-left: none; border-top: none;"> .</td>
		<td style="border-top: none; border-right: none;"></td>
