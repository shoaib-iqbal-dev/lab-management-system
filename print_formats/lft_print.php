...
// Validate input
if (empty($receipt_id) || empty($mr_no) || strtolower($test_name) !== 'lft') {
...
$testQuery = "SELECT lft.*, receipts.receipt_no, receipts.actual_fee, receipts.discount, receipts.total_fee, receipts.payment_date
              FROM lft
              LEFT JOIN receipts ON lft.receipt_id = receipts.receipt_id
              WHERE lft.receipt_id = ?";
$testStmt = $conn->prepare($testQuery);
$testStmt->bind_param("i", $receipt_id);
$testStmt->execute();
$testResult = $testStmt->get_result();
if ($testResult->num_rows === 0) {
    echo "<h3>No LFT result found for this receipt.</h3>";
    exit;
}
...
<p style="margin-bottom: 0px;margin-top: 0px;"><b>Liver Function Tests</b></p>

<table class="result-table" style="margin-top: 5px;margin-bottom: 30px; font-size:10;">
    
<tr>
        <th style="width: 25%; border-left: none; text-align:left;">Test</th>
        <th style="width: 18%; text-align:center;">Reference Value</th>
		<th style="width: 10%; text-align:center;">Unit</th>
		<th style="width: 10%; text-align:center;">Result</th>
		<th style="width: 32%; border-right: none; text-align:center;"></th>
    </tr><tr>
	<td><b>Serum Total Bilirubin</b></td>
	<td style="text-align:center;">3.4 - 17.1</td>
	<td style="text-align:center;">u mol/L</td>
	<td style="text-align:center;"><?= $row['serum_total_bilirubin'] ?></td>
	<td></td>
	</tr>
    <tr>
	<td><b>Bilirubin Direct</b></td>
	<td style="text-align:center;"><5.1</td>
	<td style="text-align:center;">u mol/L</td>
	<td style="text-align:center;"><?= $row['serum_conjugated_bilirubin'] ?></td>
	<td></td>
	</tr>
    <tr>
	<td><b>Bilirubin Indirect</b></td>
	<td style="text-align:center;"><11.9</td>
	<td style="text-align:center;">mmol/L</td>
	<td style="text-align:center;"><?= $row['serum_unconjugated_bilirubin'] ?></td>
	<td></td>
	</tr>
    <tr>
	<td><b>Serum ALT (SGPT)</b></td>
	<td style="text-align:center;">Male: 9 - 42<br>Female: 9 - 32</td>
	<td style="text-align:center;">U/L</td>
	<td style="text-align:center;"><?= $row['serum_alt'] ?></td>
	<td></td>
	</tr>
    <tr>
	<td><b>Serum AST (SGOT)</b></td>
	<td style="text-align:center;"><31</td>
	<td style="text-align:center;">U/L</td>
	<td style="text-align:center;"><?= $row['serum_ast'] ?></td>
	<td></td>
	</tr>
    <tr>
	<td><b>Serum Alkaline Phosphate (ALP) </b></td>
	<td style="text-align:center;">Children: 56 - 645<br>Adult: 270</td>
	<td style="text-align:center;">U/L</td>
	<td style="text-align:center;"><?= $row['serum_alkaline_phosphate'] ?></td>
	<td></td>
	</tr>
