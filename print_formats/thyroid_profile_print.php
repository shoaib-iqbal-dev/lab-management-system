...
// Validate input
if (empty($receipt_id) || empty($mr_no) || strtolower($test_name) !== 'thyroid profile') {
...
$testQuery = "SELECT thyroid_profile.*, receipts.receipt_no, receipts.actual_fee, receipts.discount, receipts.total_fee, receipts.payment_date
              FROM thyroid_profile
              LEFT JOIN receipts ON thyroid_profile.receipt_id = receipts.receipt_id
              WHERE thyroid_profile.receipt_id = ?";
$testStmt = $conn->prepare($testQuery);
$testStmt->bind_param("i", $receipt_id);
$testStmt->execute();
$testResult = $testStmt->get_result();
if ($testResult->num_rows === 0) {
    echo "<h3>No Throid Profile result found for this receipt.</h3>";
    exit;
}
...
<html>
<head>
    <title>Thyroid Profile Report</title>
    <style>
        body {
...
<hr style="margin-top: 0px;margin-bottom: 0px;">
<p style="margin-bottom: 0px;margin-top: 0px;"><b>Thyroid Profile- 1</b></p>
<table class="result-table" style="margin-top: 0px;margin-bottom: 0px; font-size:12">
    
<tr>
        <th style="width: 18%; border-left: none;">Test</th>
        <th style="width: 20%;">Reference Value</th>
		<th style="width: 10%;">Unit</th>
		<th style="width: 10%;">Result</th>
		<th style="width: 37%; border-right: none;"></th>
    </tr>
	<tr>
	<td><b>Serum Total T4</b></td>
	<td style="text-align:center;">(See Below)</td>
	<td style="text-align:center;">ug/dl</td>
	<td style="text-align:center;"><?= $row['serum_total_t4'] ?></td>
	<td style="text-align:center;"></td>
	</tr>
</table>
<table style="width:95%; text-align:left; font-size:10;">
<tr>
<th style="width:20%;">
<u>Reference Values:</u>
</th>
<th style="width:20%;">
</th>
<th style="width:10%;">
...
<table class="result-table" style="margin-top: 0px;margin-bottom: 0px; font-size:12">  
<tr>
        <td style="width: 18%; border-left: none;"><b>Serum Total T3</b></td>
        <td style="width: 20%;text-align:center;">(See Below)</td>
		<td style="width: 10%; text-align:center;">ng/dl</td>
		<td style="width: 10%; text-align:center;"><?= $row['serum_total_t3'] ?></td>
...
<table class="result-table" style="margin-top: 0px;margin-bottom: 0px; font-size:12">  
<tr>
        <td style="width: 18%; border-left: none;"><b>Serum TSH</b></td>
        <td style="width: 20%;text-align:center;">(See Below)</td>
		<td style="width: 10%; text-align:center;">uIU/mL</td>
		<td style="width: 10%; text-align:center;"><?= $row['serum_tsh'] ?></td>
		<td style="width: 37%;"></td>
    </tr>
</table>
<table style="width:95%; text-align:left; font-size:10;">
