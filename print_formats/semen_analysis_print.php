...
// Validate input
if (empty($receipt_id) || empty($mr_no) || strtolower($test_name) !== 'semen analysis') {
...
$testQuery = "SELECT semen_analysis.*, receipts.receipt_no, receipts.actual_fee, receipts.discount, receipts.total_fee, receipts.payment_date
              FROM semen_analysis
              LEFT JOIN receipts ON semen_analysis.receipt_id = receipts.receipt_id
              WHERE semen_analysis.receipt_id = ?";
$testStmt = $conn->prepare($testQuery);
$testStmt->bind_param("i", $receipt_id);
$testStmt->execute();
$testResult = $testStmt->get_result();
if ($testResult->num_rows === 0) {
    echo "<h3>No Semen Analysis result found for this receipt.</h3>";
    exit;
}
...
<table width="100%">
  <tr>
	...
	<h3 style="margin-bottom: 0px;">Department of Clinical Pathalogy</h3>
	</td>
...
<hr style="margin-top: 0px;margin-bottom: 0px;">
<p style="margin-bottom: 0px;margin-top: 0px;"><b>Semen Analysis</b></p>

<table class="result-table" style="margin-top: 0px;margin-bottom: 30px; font-size:12;">
    
<tr>
        <th style="width: 28%; border-left: none;">Test</th>
        <th style="width: 20%;">Reference Value</th>
		<th style="width: 10%;">Unit</th>
		<th style="width: 20%;">Result</th>
		<th style="width: 17%; border-right: none;"></th>
    </tr>
<tr>
<td style="font-size:14;"><b>Physical Examination</b></td>
</tr>
	<tr>
	<td>Colour</td>
	<td>Grayish White</td>
	...
	<td>15</td>
	<td>minute</td>
	<td><?= $row['liquification_time'] ?></td>
	<td></td>
	</tr>
  <tr>
<td style="font-size:14;"><b>Microscopic Examination</b></td>
</tr>
	<tr>
	<td>Total Sperm Count</td>
	<td>60 -- 150</td>
	<td>million/ml</td>
	<td><?= $row['total_sperm_count'] ?></td>
	<td></td>
	</tr>  
		<tr>
	<td>Active Motile</td>
