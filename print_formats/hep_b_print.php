...
// Validate input
if (empty($receipt_id) || empty($mr_no) || strtolower($test_name) !== 'hep b') {
...
$testQuery = "SELECT hep_b.*, receipts.receipt_no, receipts.actual_fee, receipts.discount, receipts.total_fee, receipts.payment_date
              FROM hep_b
              LEFT JOIN receipts ON hep_b.receipt_id = receipts.receipt_id
              WHERE hep_b.receipt_id = ?";
$testStmt = $conn->prepare($testQuery);
$testStmt->bind_param("i", $receipt_id);
$testStmt->execute();
$testResult = $testStmt->get_result();
if ($testResult->num_rows === 0) {
    echo "<h3>No Hep B result found for this receipt.</h3>";
    exit;
}
...
<table width="100%">
  <tr>
	...
	<h3 style="margin-bottom: 0px;">Department of Virology</h3>
	</td>
...
<hr style="margin-top: 0px;margin-bottom: 0px;">
<p style="margin-bottom: 0px;margin-top: 0px;"><b>Serum HBsAg</b></p>
...
<tr>
        ...
        <th style="width: 32%; border-top: none; border-bottom: none; border-right: none;"><h1><?= $row['hep_b'] ?></h1></th>
    </tr>
	<tr>
...
<hr style="margin-top: 0px;margin-bottom: 0px;">
<p style="margin-bottom: 0px;margin-top: 0px;"><b>Serum Anti-HCV</b></p>

<table class="result-table" style="margin-top: 0px;margin-bottom: 10px; font-size:12">
    
<tr>
        <th style="width: 40%; border-left: none; border-top: none; border-bottom: none;"></th>
        <th style="width: 32%; border-top: none; border-bottom: none; border-right: none;"><h1><?= $row['hep_c'] ?></h1></th>
    </tr>
	<tr>
		<td style="width: 40%; border-left: none; border-top: none;"> .</td>
		<td style="border-top: none; border-right: none;"></td>
...
<hr style="margin-top: 0px;margin-bottom: 0px;">
<p style="margin-bottom: 0px;margin-top: 0px;"><b>HIV</b></p>

<table class="result-table" style="margin-top: 0px;margin-bottom: 10px; font-size:12">
    
<tr>
        <th style="width: 40%; border-left: none; border-top: none; border-bottom: none;"></th>
        <th style="width: 32%; border-top: none; border-bottom: none; border-right: none;"><h1><?= $row['hiv'] ?></h1></th>
    </tr>
	<tr>
		<td style="width: 40%; border-left: none; border-top: none;"> .</td>
		<td style="border-top: none; border-right: none;"></td>
...
<br>
<p style="font-size:12px;">All Immunochronic Test (ICT) are indirect evidence of disease. In case of any doubt please repeat another method like ELISA.
</p>
