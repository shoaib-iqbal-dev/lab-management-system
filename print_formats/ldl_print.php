...
// Validate input
if (empty($receipt_id) || empty($mr_no) || strtolower($test_name) !== 'ldl') {
...
$testQuery = "SELECT ldl.*, receipts.receipt_no, receipts.actual_fee, receipts.discount, receipts.total_fee, receipts.payment_date
              FROM ldl
              LEFT JOIN receipts ON ldl.receipt_id = receipts.receipt_id
              WHERE ldl.receipt_id = ?";
