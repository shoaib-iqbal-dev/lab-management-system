...
// Validate input
if (empty($receipt_id) || empty($mr_no) || strtolower($test_name) !== 'serum fsh') {
...
$testQuery = "SELECT serum_fsh.*, receipts.receipt_no, receipts.actual_fee, receipts.discount, receipts.total_fee, receipts.payment_date
              FROM serum_fsh
              LEFT JOIN receipts ON serum_fsh.receipt_id = receipts.receipt_id
              WHERE serum_fsh.receipt_id = ?";
$testStmt = $conn->prepare($testQuery);
$testStmt->bind_param("i", $receipt_id);
$testStmt->execute();
$testResult = $testStmt->get_result();
if ($testResult->num_rows === 0) {
    echo "<h3>No Serum FSH result found for this receipt.</h3>";
    exit;
}
...
<table style="width:95%; text-align:left; font-size:12;">
<tr>
<td style="font-size:12px;">Reference Values:
</td>
</tr>
<tr>
<th style="width:30%;">
...
<tr>
<td>Follicular Phase: 3.5-12.5 IU/L
</td>
</tr>
<tr>
<td>Ovulation Phase: 4.7-21.5 IU/L
</td>
</tr>
<tr>
<td>Luteal Phase: 1.7-7.7 IU/L
</td>
</tr>
<tr>
<td>Post menopause: 25.8-134.8 IU/L
</td>
</tr>
</table>
