...
// Validate input
if (empty($receipt_id) || empty($mr_no) || strtolower($test_name) !== 'phosphate') {
...
$testQuery = "SELECT phosphate.*, receipts.receipt_no, receipts.actual_fee, receipts.discount, receipts.total_fee, receipts.payment_date
              FROM phosphate
              LEFT JOIN receipts ON phosphate.receipt_id = receipts.receipt_id
              WHERE phosphate.receipt_id = ?";
...
<tr>
    ...
    <tr>
	<td>Phosphate</td>
	<td>Adult: 2.5 - 5.0 g/dl<br>Child: 8.5 - 10.5</td>
	<td><?= $row['phosphate'] ?></td>
	<td></td>
	</tr>
