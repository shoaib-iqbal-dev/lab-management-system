...
// Validate input
if (empty($receipt_id) || empty($mr_no) || strtolower($test_name) !== 'tg cholesterol') {
...
$testQuery = "SELECT tg_cholesterol.*, receipts.receipt_no, receipts.actual_fee, receipts.discount, receipts.total_fee, receipts.payment_date
              FROM tg_cholesterol
              LEFT JOIN receipts ON tg_cholesterol.receipt_id = receipts.receipt_id
              WHERE tg_cholesterol.receipt_id = ?";
