...
// Validate input
if (empty($receipt_id) || empty($mr_no) || strtolower($test_name) !== 'cbc profile') {
...
$testQuery = "SELECT cbc_profile.*, receipts.receipt_no, receipts.actual_fee, receipts.discount, receipts.total_fee, receipts.payment_date
              FROM cbc_profile
              LEFT JOIN receipts ON cbc_profile.receipt_id = receipts.receipt_id
              WHERE cbc_profile.receipt_id = ?";
$testStmt = $conn->prepare($testQuery);
$testStmt->bind_param("i", $receipt_id);
$testStmt->execute();
$testResult = $testStmt->get_result();
if ($testResult->num_rows === 0) {
    echo "<h3>No CBC Profile result found for this receipt.</h3>";
    exit;
}
...
<html>
<head>
    <title>CBC Profile Report</title>
    <style>
        body {
...
<table width="100%">
  <tr>
	...
	<h3 style="margin-bottom: 0px;">Department of Hematology</h3>
	</td>
...
<hr style="margin-top: 0px;margin-bottom: 0px;">
<p style="margin-bottom: 0px;margin-top: 0px;"><b>Blood C/P (Complete,CBC)</b></p>

<table class="result-table" style="margin-top: 0px;margin-bottom: 30px; font-size:12">
...
<tr>
	...
	<td>Haemoglobin</td>
	<td>Male: (13.5 –18.0)<br>Female: (12.0 -16.0)</td>
	<td>g/dL</td>
    ...
    <tr>
	<td>RBC</td>
	<td>Male: (4.5 - 6.5)<br>Female: (3.9 - 5.6)</td>
	<td>X10^12/L</td>
	<td><?= $row['rbc'] ?></td>
	<td></td>
	</tr>
    <tr>
	<td>Haematocrit</td>
	<td>Male: (41 - 48)<br>Female: (35 - 42) </td>
	<td>%</td>
	<td><?= $row['haematocrit'] ?></td>
	<td></td>
	</tr>
    <tr>
	<td>MCV</td>
    ...
    <tr>
	<td>Total White Cells</td>
	<td>02 month (5.5 - 18.0)<br>02 yrs (6.0 - 17.0)<br>8-12 yrs (4.5 - 13.5)<br>Adult (4.0 - 11.0)</td>
	<td>X10^9/L</td>
	<td><?= $row['white_cells'] ?></td>
	<td></td>
	</tr>
    <tr>
	<td>Neutrophils</td>
