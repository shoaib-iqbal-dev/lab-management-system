...
// Validate input
if (empty($receipt_id) || empty($mr_no) || strtolower($test_name) !== 'blood grouping') {
...
$testQuery = "SELECT blood_grouping.*, receipts.receipt_no, receipts.actual_fee, receipts.discount, receipts.total_fee, receipts.payment_date
              FROM blood_grouping
              LEFT JOIN receipts ON blood_grouping.receipt_id = receipts.receipt_id
              WHERE blood_grouping.receipt_id = ?";
...
<html>
<head>
    <title>Blood Grouping Report</title>
    <style>
        body {
...
<table width="100%">
  <tr>
	...
	<h3 style="margin-bottom: 0px;">Department of Blood Bank</h3>
	</td>
