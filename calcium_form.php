...
if ($receipt_id <= 0) {
    ...
    $check_sql = "SELECT * FROM calcium WHERE receipt_id = $receipt_id";
    ...
    if (mysqli_num_rows($check_result) > 0) {
        ...
        $existing_data = ['calcium' => '', 'reporting_datetime' => ''];
    }
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($edit_mode) {
        $update_sql = "UPDATE calcium SET calcium = '$calcium', reporting_datetime = NOW() WHERE receipt_id = $receipt_id";
        ...
        $insert_sql = "INSERT INTO calcium (receipt_id, calcium, reporting_datetime) VALUES ($receipt_id, '$calcium', NOW())";
...
<div class="container" style="margin-bottom: 100px;">
    ...
    <form method="post" action="">
        <label for="calcium">Calcium Result:</label>
        <input type="text" name="calcium" id="calcium" required value="<?= htmlspecialchars($existing_data['calcium']) ?>" />
