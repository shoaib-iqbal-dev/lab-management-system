...
$fetch_sql = "SELECT * FROM pt WHERE receipt_id = $receipt_id";
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($edit_mode) {
        ...
        $insert_sql = "INSERT INTO pt (receipt_id, pt, pt_control, aptt, aptt_control, inr, reporting_datetime) 
