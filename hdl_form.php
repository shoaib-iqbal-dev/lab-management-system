...
if ($receipt_id <= 0) {
    ...
    $check_sql = "SELECT * FROM hdl WHERE receipt_id = $receipt_id";
    ...
    if (mysqli_num_rows($check_result) > 0) {
        ...
        $existing_data = ['serum_hdl_cholesterol' => '', 'reporting_datetime' => ''];
    }
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($edit_mode) {
        $update_sql = "UPDATE hdl SET serum_hdl_cholesterol = '$serum_hdl_cholesterol', reporting_datetime = NOW() WHERE receipt_id = $receipt_id";
        ...
        $insert_sql = "INSERT INTO hdl (receipt_id, serum_hdl_cholesterol, reporting_datetime) VALUES ($receipt_id, '$serum_hdl_cholesterol', NOW())";
